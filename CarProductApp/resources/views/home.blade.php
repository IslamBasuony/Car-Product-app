...
@section('content')
    ...
    {{-- <div class="logos">
        <ul>
            <li class="{{ $activeTab == 'sedan' ? 'active' : '' }}"><a href="sedan" onclick="showTab('sedan')">sedan</a></li>
            <li class="{{ $activeTab == 'suv' ? 'active' : '' }}"><a href="suv" onclick="showTab('suv')">suv</a></li>
            <li class="{{ $activeTab == 'premium' ? 'active' : '' }}"><a href="premium" onclick="showTab('premium')">premium</a></li>
            <li class="{{ $activeTab == 'coupe' ? 'active' : '' }}"><a href="coupe" onclick="showTab('coupe')">coupe</a></li>
            <li class="{{ $activeTab == 'hatchback' ? 'active' : '' }}"><a href="hatchback" onclick="showTab('hatchback')">hatchback</a></li>
            <li class="{{ $activeTab == 'crossover' ? 'active' : '' }}"><a href="crossover" onclick="showTab('crossover')">crossover</a></li>
        </ul>
    </div> --}}
    {{-- <section class="main_card" >
        <div id="sedan" class="tab-content {{ $activeTab == 'sedan' ? 'active' : '' }}">
            <div class='main_card'>
                @foreach ($cars as $car)
        ...
        <div id="suv" class="tab-content {{ $activeTab == 'suv' ? 'active' : '' }}" style="display: none;">
            <div class='main_card'>
                @foreach ($cars as $car)
                    <div class=" gallary_app card ">
                        @if ($car->body == 'suv')
        ...
        <div id="premium" class="tab-content {{ $activeTab == 'premium' ? 'active' : '' }}" style="display: none;">
            <div class='main_card'>
                @foreach ($cars as $car)
                    <div class=" gallary_app card ">
                        @if ($car->body == 'suv')
        ...
        <div id="coupe" class="tab-content {{ $activeTab == 'coupe' ? 'active' : '' }}" style="display: none;">
            <div class='main_card'>
                @foreach ($cars as $car)
                    <div class=" gallary_app card ">
                        @if ($car->body == 'suv')
        ...
        <div id="hatchback" class="tab-content {{ $activeTab == 'hatchback' ? 'active' : '' }}" style="display: none;">
            <div class='main_card'>
                @foreach ($cars as $car)
                    <div class=" gallary_app card ">
                        @if ($car->body == 'suv')
        ...
        <div id="crossover" class="tab-content {{ $activeTab == 'crossover' ? 'active' : '' }}" style="display: none;">
            <div class='main_card'>
                @foreach ($cars as $car)
                    <div class=" gallary_app card ">
                        @if ($car->body == 'suv')
